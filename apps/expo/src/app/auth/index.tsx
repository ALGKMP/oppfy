    ...
    <View flex={1} backgroundColor={"$background"}>
      ...
      <YStack marginBottom="$6" marginHorizontal="$4"padding="$2" space={"$4"}>
        <Text padding={"$2"} textAlign="center" fontSize={12}>
          By tapping &apos;Sign in&apos;, you agree with our <Text fontWeight={"500"} textDecorationLine="underline">Terms.</Text> Learn how we process your data in our <Text fontWeight={"500"} textDecorationLine="underline">Privacy Policy</Text> and <Text fontWeight={"500"} textDecorationLine="underline">Cookies Policy</Text>.
        </Text>
        ...
        <Button backgroundColor={"$backgroundTransparent"} padding={'$2'} borderRadius={16} borderColor={"white"} borderWidth={1}>
