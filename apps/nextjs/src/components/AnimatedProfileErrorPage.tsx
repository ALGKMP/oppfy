...
export default function AnimatedProfileErrorPage() {
  return (
    <div className="container flex flex-col items-center justify-center gap-8 px-4 py-16">
      ...
      >
        We couldn't find the profile you're looking for. Join Oppfy to connect
        with amazing people and share authentic moments!
      </motion.p>
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400">Share authentic photos</p>
        </div>
        <div className="text-center">
          <span className="mb-2 block text-3xl">✨</span>
